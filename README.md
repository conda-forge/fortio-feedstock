...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fortio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14464&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fortio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fortio` can be installed with:

```
conda install fortio
```

It is possible to list all of the versions of `fortio` available on your platform with:
